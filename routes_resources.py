...
register_simple_resource(
    "purchases", "purchases",
    fields=["receipt_id", "date", "item", "supplier", "account", "qty", "price"],
...
register_simple_resource(
    "expenses", "expenses",
    fields=["date", "category", "description", "amount", "account"],
    numeric_fields=("amount",),
)

register_simple_resource(
    "cash", "cash",
    fields=["date", "account", "amount", "note"],
    numeric_fields=("amount",),
)
...
register_simple_resource(
    "pumice", "pumice",
    fields=["date", "type", "qty", "price", "amount"],
    numeric_fields=("qty", "price", "amount"),
)

register_simple_resource(
    "stock-logs", "stock_logs",
    fields=["product_id", "date", "qty_change", "reason"],
    numeric_fields=("product_id", "qty_change"),
)
